function jac_str = generate_ascii9(jac,gleft,gright,stf,trline_idx,wave_lines,wave_info,jac_patch2)
% generate ASCII code out of 2D Jacquard coordinates
% added in v7: everything within the form is coded differently
% added in v8: new CA
% added in v9: waves and different colors for transit lines
% [rgbs,symbs] = importCA('ISPO2019_Farbpalette.scpx');
% specify ascii symbol for each op
dont_knit = '.';
default_color = 'A';
stoll_color = 'I';
edge_right = '+';
